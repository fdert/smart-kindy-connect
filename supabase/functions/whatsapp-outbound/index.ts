...
عزيزنا *${templateData.guardianName || 'ولي الأمر الكريم'}* 🌟
...
🎯 *الموضوع:*
${templateData.permissionTitle || 'إذن عام'}

📝 *التفاصيل:*
${templateData.permissionDescription || 'يرجى مراجعة التفاصيل'}
...
🎯 *العنوان:*
${templateData.surveyTitle || 'استطلاع رأي'}

${templateData.surveyDescription ? `📝 *الوصف:*
${templateData.surveyDescription}

` : ''}${templateData.surveyQuestions && templateData.surveyQuestions.length > 0 ? `❓ *الأسئلة المتضمنة:*
