...
السلام عليكم ${templateData.guardianName || 'ولي الأمر الكريم'} ✨

الموضوع: ${templateData.permissionTitle || 'إذن عام'}

التفاصيل: ${templateData.permissionDescription || 'يرجى مراجعة التفاصيل'}

الطالب: ${templateData.studentName || 'الطالب'}
ينتهي في: ${templateData.expiresAt || 'غير محدد'}

للاستجابة اضغط الرابط:
${permissionUrl}

ملاحظة: يمكنكم الرد بـ موافق أو غير موافق
...
العنوان: ${templateData.surveyTitle || 'استطلاع رأي'}
...
ملاحظة: الاستطلاع لن يستغرق دقائق معدودة
