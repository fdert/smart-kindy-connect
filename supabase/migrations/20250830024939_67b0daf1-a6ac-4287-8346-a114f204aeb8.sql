-- إنشاء الحسابات التجريبية يدوياً
-- إدراج المستخدمين بمعرفات مخصصة في جدول auth.users
...
-- تحديث owner_id للتينانت التجريبي واستخدام 'approved' بدلاً من 'active'
UPDATE public.tenants 
SET owner_id = '00000000-0000-0000-0000-000000000002', status = 'approved'
