...
VALUES 
  ('22222222-2222-2222-2222-222222222222', 'ALN001', 'سارة محمد العتيبي', '2020-03-15', 'أنثى', 
   (SELECT id FROM classes WHERE tenant_id = '22222222-2222-2222-2222-222222222222' AND name = 'التمهيدي الأول' LIMIT 1), 
   '2024-09-01', true),
  ('22222222-2222-2222-2222-222222222222', 'ALN002', 'عبدالله أحمد الشمري', '2019-07-22', 'ذكر', 
   (SELECT id FROM classes WHERE tenant_id = '22222222-2222-2222-2222-222222222222' AND name = 'التمهيدي الثاني' LIMIT 1), 
   '2024-09-01', true);