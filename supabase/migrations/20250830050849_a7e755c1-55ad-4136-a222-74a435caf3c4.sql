...
VALUES 
  ...
  ('22222222-2222-2222-2222-222222222222', 'ALN003', 'نورا خالد المطيري', '2020-01-10', 'أنثى', (SELECT id FROM classes WHERE tenant_id = '22222222-2222-2222-2222-222222222222' AND name = 'التمهيدي الأول' LIMIT 1), '2024-09-01', true);